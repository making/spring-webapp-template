package am.ik.template.app.user.controller;
...
import am.ik.template.app.user.facade.UserFacade;
import am.ik.template.app.user.model.UserCreateForm;
import am.ik.template.app.user.model.UserDeleteForm;
...
public class UserController {
    ...
    public String createConfirm(@Valid
    ...
    public String updateForm(@RequestParam("id")
    Integer id, UserUpdateForm form, Model model) {
    ...
    public String updateConfirm(@Valid
    UserUpdateForm form, BindingResult result) {
        if (result.hasErrors()) {
            return "user/updateForm";
        }
    ...
    public String deleteConfirm(@RequestParam("id")
    Integer id, UserDeleteForm form, Model model) {
        User user = userService.findOne(id);
        BeanUtils.copyProperties(user, form);
    ...
    UserDeleteForm form, BindingResult result, RedirectAttributes attr) {
        if (result.hasErrors()) {
